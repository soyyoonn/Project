...
def monster_appear(nomal_monster, boss_monster):
    rand = random.uniform(99, 100)  # 확률 범위 0~100
    # 일반 몬스터
    if rand < 46.5:
    ...
    #     return boss_monster[0]  # 아르헨도
    # elif (rand >= 94.5) and (rand < 95.5):
    #     return boss_monster[1]  # 철몸
    # elif (rand >= 95.5) and (rand < 96.5):
    #     return boss_monster[2]  # 규범이
    # elif (rand >= 96.5) and (rand < 97.5):
    #     return boss_monster[3]  # 민주석
    # elif (rand >= 97.5) and (rand < 98.5):
    #     return boss_monster[4]  # 일성김
    # elif (rand >= 98.5) and (rand < 99.5):
    #     return boss_monster[5]  # 우연이
    elif (rand >= 99.5) and (rand < 100):
        return boss_monster[0]  # 디아복로
...
def nomal_monster_fc():
    ...
    sukll = Monster("해골", 200, random.randrange(480, 801))
...
def boss_monster_fc():
    ...
    # arhendo = Monster("아르헨도", random.randrange(1000, 3001), random.randrange(50, 101))
...
# 파티원 객체 리스트 만드는 함수
def party_list_fc():
    yong = Choco('초코의용', 5000, 300)  # yong 객체. Choco의 인스턴스
    tae = King('킹기태', 5000, 300)  # tae 객체. King의 인스턴스
    jae = Bow('보우연재', 5000, 300)  # jae 객체. Bow의 인스턴스
    beom = Tiger('약범규', 5000, 300)  # beom 객체. beom은 Tiger의 인스턴스
